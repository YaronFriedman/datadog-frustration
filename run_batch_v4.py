#!/usr/bin/env python3
"""Fire the same 30 seeded queries against frustration_agent v4 and log to Deepchecks v4."""
...
os.environ.setdefault("DEEPCHECKS_VERSION", "v4")
...
from frustration_agent_v4.agent import root_agent

APP_NAME = "frustration_agent_v4"


async def _run_one(runner: Runner, session_service: InMemorySessionService, prompt: str) -> int:
    user_id = f"batch-v4-{uuid.uuid4().hex[:8]}"
