#!/usr/bin/env python3
"""Fire the same 30 seeded queries against frustration_agent v5 and log to Deepchecks v5."""
...
os.environ.setdefault("DEEPCHECKS_VERSION", "v5")
...
from frustration_agent_v5.agent import root_agent

APP_NAME = "frustration_agent_v5"


async def _run_one(runner: Runner, session_service: InMemorySessionService, prompt: str) -> int:
    user_id = f"batch-v5-{uuid.uuid4().hex[:8]}"
